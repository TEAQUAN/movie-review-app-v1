const jwt = require('jsonwebtoken'); //  What is the use of JSON Web Token
...
exports.resetPassword = async (req, res) => {
  ...
  if (matched) return sendError(res, "The new password must be diffrent from the old one!");
  ...
  transport.sendMail({
    ...
    html: `
      <h1>Password has being succesfully changed</h1>
      <a>You can sign in now</a>
    `,
  });
...
exports.signIn = async (req, res, next) => {
  ...
  res.json({ user: { id: _id, name, email,role, token: jwToken, isVerified, role } })
}
